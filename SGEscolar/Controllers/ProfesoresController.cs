...
namespace SGEscolar.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public ProfesoresController(SgescolarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesores != null ? 
                          ...
                          Problem("Entity set 'SgescolarContext.Profesores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ProfesorId,ProfesorNombre,ProfesorTelefono,ProfesorCorreo")] Profesore profesore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfesorId,ProfesorNombre,ProfesorTelefono,ProfesorCorreo")] Profesore profesore)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SgescolarContext.Profesores'  is null.");
            }
            var profesore = await _context.Profesores.FindAsync(id);
            if (profesore != null)
            {
